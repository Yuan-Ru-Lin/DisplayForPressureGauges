...
- **JuliaApp** - Julia application for fetching data from ADS1115, convert raw values to pressure and then insert final values into a table in the PostgreSQL database
